...
class TeamAssigner:
    ...
    def get_palyer_color(self, frame, bbox):
        ...
        player_clor = kmeans.cluster_centers_[player_cluster]
    ...
    def assign_team_color(self, frame, player_detections):
        ...
        for _, player_detection in  player_detections.items():
            ...
            player_colors.append(self.get_palyer_color(frame, bbox))
    ...
    def get_player_team(self, frame, player_bbox, player_id):
        ...
        player_color = self.get_palyer_color(frame, player_bbox)
